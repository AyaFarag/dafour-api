                            ...
                            <div class="col-sm-12">
                                <table id="pros" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            <td>{{ str_limit($location->title_en, 25) }}</td>
                                            <td>{{ str_limit($location->title_ar, 25) }}</td>
                                            <td>
                                                {!! Form::model($location, ['route' => ['admin.locations.destroy', $location->id], 'method' => 'post', 'onsubmit' => 'return confirm("Are you sure");']) !!}
                                                    <a href="{!! route('admin.locations.edit', $location->id) !!}" class="btn btn-xs btn-primary" type="submit">View</a>
